    ...
    public class Field
    {
        ...
        public void Progress()
        {
            ...
            while (true)
            {
                ...
                {
                    //몬스터를 만들고
                    //1번일때 초보몬스터, 2번일때 중급몬스터, 3번일때 고급몬스터
        ...
        public void Create(string _strName, int _iHp, int _iAttack, out Monster pMonster)
        {
            ...
            pMonster.SetMonster(tMonster); //생성된 데이터 INFO 클래스 탕비 이자로 데이터 세팅
        }
        ...
        public void CreateMonster(int input) 
        {
            switch (input)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Create("초보몹", 60, 6, out m_pMonster);
                    break;
                case 3:
