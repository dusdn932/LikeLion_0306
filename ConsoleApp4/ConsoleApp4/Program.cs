...
namespace ConsoleApp4
{
    ...
    //추상메서드만 포함(구현X) -> 인터페이스를 구현하는 클래스에서 반드시 구현해야함
    ...
    class Cat : IAinimal
    {
        public void MakeSound()
        {
            Console.WriteLine("나옹!");
        }
    }*/
    /*//인터페이스 예제
    //인터페이스를 활용하면 객체가 어떤 특정한 동작을 보장함녀서도 다양한 형태로 사용
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PaymentPorcessor processor = new PaymentPorcessor();
